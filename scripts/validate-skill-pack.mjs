...
const requiredFiles = [
  ...
  "SKILLS/spritesheet-expert/references/creature-animation.md",
  "SKILLS/spritesheet-expert/references/isometric-tilesets.md",
  "SKILLS/spritesheet-expert/references/lucida-adaptive-workflow.md",
  "SKILLS/spritesheet-expert/references/grok-video-animation.md",
  "SKILLS/spritesheet-expert/references/video-animation-workflow.md",
  ...
  "SKILLS/spritesheet-expert/scripts/requirements-lucida.txt",
  ...
  "SKILLS/spritesheet-expert/scripts/ingest_video_animation.py",
  "SKILLS/spritesheet-expert/scripts/build_video_frame_selector.py",
  ...
  "SKILLS/spritesheet-expert/references/schemas/video-source-v1.schema.json",
